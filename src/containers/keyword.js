...
export default class KeywordContainer {
  constructor(subject, renderKeyword) {
    ...
    this.keywordsElement = document.querySelector("#keywords"),
  ...
  handleAddKeyword(event) {
    ...
    this.keywordsElement.classList.add("show");
  ...
  handleRemoveKeyword(event) {
    ...
    if (this.keywords.length === 0) this.keywordsElement.classList.remove("show");
  }
}
