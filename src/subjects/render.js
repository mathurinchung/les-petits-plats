...
export default class RenderSubject extends Subject {
  constructor(recipes) {
    super();
  ...
  updateRender(terms) {
    ...
    const emptyElement = document.querySelector('#recipes .empty');
    emptyElement.classList.toggle('show', setRecipes.length === 0);
